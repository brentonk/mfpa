...
- In probability applications specifically, the "universe" is the set of all possible outcomes of the random process being considered.
  ...
  For example, in the context of a survey of three people who are asked whether they approve of the president's job performance, the universe is the set of the eight possible combinations of responses:
  $$
  \Omega = \left\{
  \begin{gathered}
  \text{1 yes, 2 yes, 3 yes}, \quad \text{1 yes, 2 yes, 3 no}, \\
  \text{1 yes, 2 no, 3 yes}, \quad \text{1 yes, 2 no, 3 no}, \\
  \text{1 no, 2 yes, 3 yes}, \quad \text{1 no, 2 yes, 3 no}, \\
  \text{1 no, 2 no, 3 yes}, \quad \text{1 no, 2 no, 3 no}
  \end{gathered}
  \right\}.
  $$
...
This is an illustration of a very useful pair of set properties called
